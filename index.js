...
const LINKEDIN_URL = 'https://www.linkedin.com/in/niklasbuchfink/';
// const LINKEDIN_URL = 'https://www.linkedin.com/in/felixhaeberle/';
// const LINKEDIN_URL = 'https://www.linkedin.com/in/nils-jacobsen/';

// const LINKEDIN_PROFIL = 'niklasbuchfink';
// const LINKEDIN_PROFIL = 'felixhaeberle';
// const LINKEDIN_PROFIL = 'nils-jacobsen';
...
(() => {
	...
	const profileHandle = extractLinkedInProfilHandle(LINKEDIN_URL);

	puppeteer.launch({ headless: true, devtools: false })
		.then(async (browser) => {
				...
				.then(() => {
					...
					content
						.then((success) => {
							...
							// save the data
							fs.writeFile('profile.json', JSON.stringify(profile, null, 4), err => {
								console.log('File successfully written!'); // Success
							});
						})
						.catch((error) => {
							console.log(error);
